declare module 'header-range-parser/index' {
  ...
  export const ERROR_INVALID_ARGUMENT: ResultWrongArgument;
  export const ERROR_STRING_IS_NOT_HEADER: ResultInvalid;
  export const ERROR_UNSATISFIABLE_RESULT: ResultUnsatisfiable;
...
declare module 'header-range-parser' {
  import main = require('header-range-parser/src/index');
  export = main;
}